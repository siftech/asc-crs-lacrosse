...
if [ -d "$thisdir/stub-blobs/${target_dirname}" ]; then
    echo "TASK RESULT: copying stub pov blob."
    cp $thisdir/stub-blobs/${target_dirname}/* ${out_path}
fi

echo "GEN-POV-BLOB-STUB - TASK RESULT: DONE"
