...
(defsystem aserve
    ...
    ;; I suspect this should be rewritten -- typically all that's
    ;; needed is an :in-order-to ((test-op (test-op "aserve/test")))
    ;; -- test-op will force loading. Suspect that the tests are run
    ;; here as a side-effect of loading the test system
    ;;  
