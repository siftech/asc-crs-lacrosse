...
# COPYRIGHT END
# ------------------------------------------------------------
# Comparo class for Prism analytic analysis
package PRT::PrismAnalyticComparo;
use PRT::LineComparo;
...
our $CLASS = "PRT::PrismAnalyticComparo";
...
my %_FIELDS = (
               ...
               key_fact_regexp    => "((^Model checking:|^Result:|^Testing result:).*)",
               # private:
              );
