...
# COPYRIGHT END
# ------------------------------------------------------------
# Comparo class for Prism simpath analysis
package PRT::PrismSimpathComparo;
use PRT::LineComparo;
...
our $CLASS = "PRT::PrismSimpathComparo";
...
my %_FIELDS = (
               ...
               show_comparisons   => 0,
               case_sensitive =>1,
               ignore_fact_regexp => "^(Version:|Date:|Time:|Hostname:|Creating random number generator with seed)",
               key_fact_regexp    => ".*",
               # private:
              );
